...
function GarbageBin({ color, height, width, onClick }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 58.67" style={{ fill: color, height: height, width: width }} onClick={onClick}>
